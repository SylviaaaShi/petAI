          ...
          <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all ${
                role === "owner" ? "bg-white text-amber-500 shadow-sm" : "text-gray-500 hover:text-gray-700"
              }`}
            >
              🐶 Pet Owner
            </button>
            <button
              ...
              className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all ${
                role === "provider" ? "bg-white text-amber-500 shadow-sm" : "text-gray-500 hover:text-gray-700"
              }`}
            >
              🏠 Care Provider
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="#" className="text-xs text-amber-500 hover:text-amber-600 font-medium">
                  Forgot password?
                </Link>
              </div>
              <input
